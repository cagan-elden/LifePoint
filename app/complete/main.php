<div class="dashboard" style="background: #ddd; box-shadow: none;">
    ...
    <div class="doubleDashboard">
            ...
            <!-- Honeypots -->
             <input type="hidden" name="hakanCalhanoglu">
             <input type="hidden" name="ardaGuler">
             <input type="hidden" name="yusufDikec">
             <input type="hidden" name="fatihTerim">
             <input type="hidden" name="joseMourinho">
